...
import img3 from "../../../public/assets/Untitled.jpg";
    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <section>
          ...
          <p className="text-lg leading-relaxed">
            Email: fahaddeveloper001@gmail.com, LinkedIn:{" "}
            <a href="[Your LinkedIn Profile URL]" className="text-blue-500">
              [Your LinkedIn Profile]
            </a>
            , GitHub:{" "}
            <a href="[Your GitHub Profile URL]" className="text-blue-500">
              [Your GitHub Profileeeeeeeeeee]
            </a>
          </p>
        </section>
      </div>
